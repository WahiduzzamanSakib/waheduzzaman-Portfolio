    ...
    return (
        <article className="min-h-screen pt-28 pb-10 px-6 bg-gray-100 dark:bg-[#080821] overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <Link
                    href="/projects"
                    className="mb-6 inline-flex items-center gap-2 px-5 py-3 rounded-xl  border border-gray-300 dark:border-gray-700  bg-white dark:bg-white/5  text-gray-700 dark:text-gray-300  shadow-md
                      hover:shadow-2xl hover:border-cyan-500 dark:hover:border-cyan-400 hover:text-cyan-500 hover:bg-cyan-500/10 hover:-translate-y-1 hover:scale-105 active:scale-95 transition-all duration-300 ease-out group"
                >
                ...
                >
                    ...
                    hover:shadow-xl
                    hover:-translate-y-1
                    hover:border-green-300 dark:hover:border-green-400/30
                    transition-all duration-300 ease-out"
                                        >
                                            <FaCheckCircle
                                                className="text-green-500 text-xl mt-1 shrink-0
                    ...
                    transition-transform duration-300">
                        ...
                        transition-all duration-300 ease-out"
                                            >
                                                <FaCheckCircle
                                                    className="text-red-500 text-xl mt-1 shrink-0
                            group-hover:scale-110
                            transition-transform duration-300"
                                                />
                        ...
                        transition-all duration-300 ease-out"
                                            >
                                                <FaCheckCircle
                                                    className="text-blue-500 text-xl mt-1 shrink-0
                            group-hover:scale-110
                            transition-transform duration-300"
                                                />
