...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center pt-32 pb-20 px-6 md:px-12 lg:px-20
        bg-white dark:bg-[#050505] transition-colors duration-500">
      <div
        ...
        >
          ...
          <Image
            ...
            alt="Md Waheduzzaman"
            fill priority
            className="object-cover rounded-full border-4 border-white dark:border-neutral-800
    shadow-2xl grayscale hover:grayscale-0 transition duration-700"/>
        </motion.div>
        ...
        <div className="max-w-3xl text-center lg:text-left">
          ...
          <motion.p
            ...
            className=" text-lg leading-relaxed text-gray-600 dark:text-gray-400 mb-10">
          ...
          <motion.div
            ...
            <button
              className="px-8 py-3 rounded-full font-semibold text-white bg-gradient-to-r from-cyan-500 to-blue-600 
            ...
            <button
              className="px-8 py-3 rounded-full font-semibold border border-gray-300 dark:border-gray-700 text-gray-800
               dark:text-white hover:bg-gray-100 dark:hover:bg-neutral-900 transition">
              Download Resume
            </button>
          </motion.div>
        </div>
